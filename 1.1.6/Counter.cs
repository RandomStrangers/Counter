...
public class Counter
{
    ...
    public static UInt128 s = UInt128.MinValue;
    public static UInt128 t = UInt128.MaxValue;
    ...
    public static void Main(string[] args)
    {
      ...
      Console.BackgroundColor = ConsoleColor.Black;
        while (a != int.MaxValue || b != int.MinValue || c != uint.MaxValue || d != uint.MinValue || e != long.MaxValue || f != long.MinValue || g != ulong.MaxValue || h != ulong.MinValue || i != short.MaxValue || j != short.MinValue || k != ushort.MaxValue || l != ushort.MinValue || m != byte.MaxValue || n != byte.MinValue || o != sbyte.MaxValue || p != sbyte.MinValue || q != Int128.MaxValue || r != Int128.MinValue || s != UInt128.MaxValue || t != UInt128.MinValue)
        {
          if (a != int.MaxValue) 
          {
            a++;
          ...
          if (s != UInt128.MaxValue) 
          {
            s++;
            Console.WriteLine(s);
          }
          if (s == UInt128.MaxValue) {
            Console.WriteLine("S is " + UInt128.MaxValue);
          }
          if (t != UInt128.MinValue)
          {
            t--;
            Console.WriteLine(t);
          }
          if (t == UInt128.MinValue) {
            Console.WriteLine("T is " + UInt128.MinValue);
          }
        }
        if (a == int.MaxValue && c == uint.MaxValue && e == long.MaxValue && g == ulong.MaxValue && i == short.MaxValue && k == ushort.MaxValue && m == byte.MaxValue && o == sbyte.MaxValue && r == Int128.MaxValue && t == UInt128.MaxValue)
        {
        ...
        if (b == int.MinValue && d == uint.MinValue && f == long.MinValue && h == ulong.MinValue && j == short.MinValue && l == ushort.MinValue && n == byte.MinValue && p == sbyte.MinValue && q == Int128.MinValue && s == UInt128.MinValue)
        {
